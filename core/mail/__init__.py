...
# anthill/framework/core/mail.py before the introduction of email
# backends and the subsequent reorganization
from anthill.framework.core.mail.message import (
    DEFAULT_ATTACHMENT_MIME_TYPE, BadHeaderError, EmailMessage,
    EmailMultiAlternatives, SafeMIMEMultipart, SafeMIMEText,
    forbid_multi_line_headers, make_msgid,
)
from anthill.framework.core.mail.utils import DNS_NAME, CachedDnsName
