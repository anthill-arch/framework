...
from ..core.utils import (
    url_add_parameters, parse_qs, handle_http_errors, constant_time_compare)
from ..core.exceptions import (
    AuthFailed, AuthCanceled, AuthUnknownError,
    AuthMissingParameter, AuthStateMissing, AuthStateForbidden, AuthTokenError)
...
class BaseOAuth1(OAuthAuth):
    ...
    def unauthorized_token(self):
        ...
        response = self.request(
            ...
            params=params,
            auth=OAuth1(key, secret, callback_uri=self.get_redirect_uri(state), decoding=decoding),
