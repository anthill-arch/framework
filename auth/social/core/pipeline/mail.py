...
@partial
async def mail_validation(backend, details, is_new=False, *args, **kwargs):
    ...
    if requires_validation and send_validation:
        ...
        if 'verification_code' in data:
            await backend.strategy.session_pop('email_validation_address')
            ...
            await backend.strategy.session_set('email_validation_address',
                                               details['email'])
