...
@MigrateCommand.option('--multidb', dest='multidb', action='store_true', default=False,
...
def init(directory=None, multidb=False):
    ...
    config = app.extensions['migrate'].migrate.call_configure_callbacks(config)
    if multidb:
        command.init(config, directory, 'app-multidb')
    else:
...
@MigrateCommand.option('--splice', dest='splice', action='store_true', default=False,
...
@MigrateCommand.option('--autogenerate', dest='autogenerate', action='store_true', default=False,
                       help=('Populate revision script with candidate '
                             'migration operations, based on comparison of database to model'))
@MigrateCommand.option('-m', '--message', dest='message', default=None, help='Revision message')
@MigrateCommand.option('-d', '--directory', dest='directory', default=None,
                       help="migration script directory (default is 'migrations')")
def revision(directory=None, message=None, autogenerate=False, sql=False,
    ...
    config = app.extensions['migrate'].migrate.get_config(directory)
...
@MigrateCommand.option('-d', '--directory', dest='directory', default=None,
                       help="migration script directory (default is 'migrations')")
@MigrateCommand.option('-x', '--x-arg', dest='x_arg', default=None, action='append',
...
@MigrateCommand.option('--branch-label', dest='branch_label', default=None,
                       help='Specify a branch label to apply to the new revision')
@MigrateCommand.option('-m', '--message', dest='message', default=None)
@MigrateCommand.option('revisions', nargs='+', help='one or more revisions, or "heads" for all heads')
@MigrateCommand.option('-d', '--directory', dest='directory', default=None,
                       help="migration script directory (default is 'migrations')")
...
@MigrateCommand.option('--head-only', dest='head_only', action='store_true', default=False,
                       help='Deprecated. Use --verbose for additional output')
@MigrateCommand.option('-v', '--verbose', dest='verbose', action='store_true', default=False,
